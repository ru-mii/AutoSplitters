...
init
{
	...
	vars.Helper["KillRick"] = vars.Helper.Make<ulong>(JitSave.AddFlag("Enemy_RickRiffsonFinal", "HandleEnemyDeathAudio"));
...
split
{
	return current.KillRick != old.KillRick && current.KillRick != 0;
}
