...
init
{
	...
	vars.Helper["EndscreenTitle"] = vars.Helper.Make<byte>(vars.Events.FunctionParentPtr("UI_DEMO_Public_PreEndscreen_C", "", "OnInitialized"), 0x460, 0xDC);
	
	// ---
	vars.Helper["CameraDepth"] = vars.Helper.Make<float>(gEngine, 0x10A8, 0x38, 0x0, 0x30, 0x3AC);
